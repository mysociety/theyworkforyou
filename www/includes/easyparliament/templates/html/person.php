...
?>
                <div class="small-12 large-3 person-button-column">
                    <a class="button alert person-contact-button" href="<?= WEBPATH ?>alert/?pid=<?=$member['person_id']?>" id="mp-alert-cta-text"><strong>Get email updates</strong><small>on this person&rsquo;s activity</small></a><?php

...
if ($member['the_users_mp'] == true) {
        $pc = $THEUSER->postcode();
?>
        <a onclick="trackLinkClick(this, 'Links', 'WriteToThem', 'User'); return false;" class="button alert person-contact-button" href="http://www.writetothem.com/?a=WMC&amp;pc=<?php htmlentities(urlencode($pc)) ?>"><strong>Send a message</strong><small>with WriteToThem</small></a>
<?php
    } elseif ($member['current_member'][HOUSE_TYPE_COMMONS]) {
?>
        <a onclick="trackLinkClick(this, 'Links', 'WriteToThem', 'MP'); return false;" class="button alert person-contact-button" href="http://www.writetothem.com/"><strong>Send a message to your MP</strong><small>with WriteToThem</small></a>
<?php
    } elseif ($member['current_member'][HOUSE_TYPE_NI]) {
?>
        <a onclick="trackLinkClick(this, 'Links', 'WriteToThem', 'MLA'); return false;" class="button alert person-contact-button" href="http://www.writetothem.com/"><strong>Send a message to your MLA</strong><small>with WriteToThem</small></a>
<?php
    } elseif ($member['current_member'][HOUSE_TYPE_SCOTLAND]) {
?>
        <a onclick="trackLinkClick(this, 'Links', 'WriteToThem', 'MSP'); return false;" class="button alert person-contact-button" href="http://www.writetothem.com/"><strong>Send a message to your MSP</strong><small>with WriteToThem</small></a>
<?php
    } elseif ($member['current_member'][HOUSE_TYPE_LORDS]) {
?>
        <a onclick="trackLinkClick(this, 'Links', 'WriteToThem', 'Lord'); return false;" class="button alert person-contact-button" href="http://www.writetothem.com/?person=uk.org.publicwhip/person/<?php echo $member['person_id']; ?>"><strong>Send a message to <?php echo $member['full_name']; ?></strong><small>with WriteToThem</small></a>
<?php
    }
}
?>

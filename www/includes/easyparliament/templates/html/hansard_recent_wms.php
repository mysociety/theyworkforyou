...
foreach ($data['data'] as $wran) {
    ...
    ?>
                <dt><a name="w<?php echo $count; ?>"></a><strong><a href="<?php echo $wran['list_url']; ?>"><?php echo $wran['parent']['body'] . ': ' . $wran['body']; ?></a></strong> <?php echo \MySociety\TheyWorkForYou\Utility\DateTime::formatDate($wran['hdate'], LONGDATEFORMAT) . ' ' .$totalcomments; ?></dt>

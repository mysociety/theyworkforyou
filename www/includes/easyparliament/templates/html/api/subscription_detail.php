...
?>
    ...
    <section class="account-form">
        ...
        <?php if ($subscription->stripe->plan) { ?>
            ...
            <p>Your current plan is <strong><?= $subscription->stripe->plan->name ?></strong>.</p>

            <p>It costs you £<?= $subscription->actual_paid ?>/mth.
            <?php if ($subscription->stripe->discount) { ?>
                (£<?= $subscription->stripe->plan->amount ?>/mth with

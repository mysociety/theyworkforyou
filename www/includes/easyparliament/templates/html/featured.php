                        ...
                        <p class="meta"><?= $featured['htime'] != '00:00:00' ? format_time($featured['htime'], TIMEFORMAT) : '' ?> <?= format_date($featured['hdate'], LONGERDATEFORMAT) ?></p>
                            <p class="meta excerpt__category"><a href="<?= $featured['more_url'] ?>"><?= $featured['desc'] ?></a></p>
                            <p class="excerpt__statement">
                                <q><?= trim_characters($featured['child']['body'], 0, 200) ?></q>
                            </p>
                        </div>

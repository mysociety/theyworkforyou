                            ...
                            <h3 class="excerpt__title"><a href="<?= $recent['list_url'] ?>"><?= $recent['parent']['body'] ?> : <?= $recent['body'] ?></a></h3>
                                ...
                                <a href="<?= $recent['child']['speaker']['url'] ?>"><?= $recent['child']['speaker']['first_name'] ?> <?= $recent['child']['speaker']['last_name'] ?></a>
                                <?php } ?>

    ...
    <div class="donation-banner__content">
        ...
        <div id="donation-banner-details" class="donation-banner__details<?= $auto_expand ? ' is-open' : '' ?>">
            ...
            <div class="donation-banner__actions">
                <a href="<?= donate_link(campaign: 'twfy_rep_page', source: $current_page) ?>" class="button tertiary">
                    Support TheyWorkForYou
                </a>
                <a href="<?= donate_link(campaign: 'twfy_rep_page', how_much: 5, how_often: 'monthly', source: $current_page) ?>" class="button button--outline">
                    £5/month
                </a>
                <a href="<?= donate_link(campaign: 'twfy_rep_page', how_much: 10, source: $current_page) ?>" class="button button--outline">
                    £10 one-off
                </a>
            </div>
        </div>

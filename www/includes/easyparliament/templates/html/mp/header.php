                ...
                <?php
                    ...
                    if ($latest_membership['current']) {
                          if ($latest_membership['constituency']) {
                            ...
                            printf(gettext('<span class="person-header__about__position__role">%s %s</span> for <span class="person-header__about__position__constituency">%s</span>'),
                                $lat, $latest_membership['rep_name'], $latest_membership['constituency']);
                        } else {
                            printf(gettext('<span class="person-header__about__position__role">%s %s</span>'),
                                $lat, $latest_membership['rep_name']);
                        }
                    } else {
                          if ($latest_membership['constituency']) {
                            printf(gettext('<span class="person-header__about__position__role">Former %s %s</span> for <span class="person-header__about__position__constituency">%s</span>'),
                                $lat, $latest_membership['rep_name'], $latest_membership['constituency']);
                        } else {
                            printf(gettext('<span class="person-header__about__position__role">Former %s %s</span>'),
                                $lat, $latest_membership['rep_name']);
                        }
                    }
?>

...
<br><label for="sendmail">Your email:</label> <input type="text" id="sendmail" name="sender_mail" value="<?=_htmlspecialchars($sender_email) ?>" size="30">
<br><label for="sendname">Your name:</label> <input type="text" id="sendname" name="sender_name" value="<?=_htmlspecialchars($sender_name) ?>" size="30">

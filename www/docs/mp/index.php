...
$known_for = '';
$current_offices_ignoring_committees = $MEMBER->offices(Office::CURRENT, Office::POST_TYPES);
...
$data['current_offices'] = $MEMBER->offices(Office::CURRENT, Office::POST_TYPES);
$data['previous_offices'] = $MEMBER->offices(Office::PREVIOUS, Office::POST_TYPES);
...
function memberships($member) {
    ...
    $posts = $member->offices(Office::CURRENT, Office::COMMITTEE_TYPES);
    if ($posts) {
    ...
    $posts = $member->offices(Office::PREVIOUS, Office::COMMITTEE_TYPES);
    if ($posts) {

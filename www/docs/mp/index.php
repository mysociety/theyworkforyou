...
function person_rebellion_rate ($member) {
    ...
    if (isset($member->extra_info['public_whip_rebellions']) && $member->extra_info['public_whip_rebellions'] != 'n/a') {
        ...
        $rebellion_string = '<a href="http://www.publicwhip.org.uk/mp.php?id=uk.org.publicwhip/member/' . $member->member_id() . '#divisions" title="See more details at Public Whip">' . _htmlentities($member->extra_info['public_whip_rebel_description']) . ' ' . $rebels_term . '</a> against their party';

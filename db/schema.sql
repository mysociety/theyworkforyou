...
CREATE TABLE `member` (
  ...
  `first_name` varchar(100) character set latin1 collate latin1_spanish_ci default NULL,
  `last_name` varchar(255) character set latin1 collate latin1_spanish_ci NOT NULL default '',
  `constituency` varchar(100) character set latin1 collate latin1_spanish_ci NOT NULL default '',
  `party` varchar(100) character set latin1 collate latin1_spanish_ci NOT NULL default '',
  `entered_house` date NOT NULL default '1000-01-01',
  `left_house` date NOT NULL default '9999-12-31',
  `entered_reason` enum('unknown','general_election','by_election','changed_party','reinstated','appointed','devolution','election','accession','regional_election','replaced_in_region','became_presiding_officer', 'general_election_probably') character set latin1 collate latin1_spanish_ci NOT NULL default 'unknown',
  `left_reason` enum('unknown','still_in_office','general_election','general_election_standing','general_election_not_standing','changed_party','died','declared_void','resigned','disqualified','became_peer','devolution','dissolution','retired','regional_election','became_presiding_officer') character set latin1 collate latin1_spanish_ci NOT NULL default 'unknown',

...
class InitialSchema extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        if (!$this->hasTable('policydivisions')) {
            $this->execute("
        ...
        if (!$this->hasTable('persondivisionvotes')) {
            $this->execute("
        ...
        if (!$this->hasTable('postcode_lookup')) {
            $this->execute("
        ...
        if (!$this->hasTable('titles_ignored')) {
            $this->execute("
        ...
        if (!$this->hasTable('future_people')) {
            $this->execute("
        ...
        if (!$this->hasTable('commentreports')) {
            $this->execute("
        ...
        if (!$this->hasTable('search_query_log')) {
            $this->execute("
        ...
        if (!$this->hasTable('video_timestamps')) {
            $this->execute("
        ...
        if (!$this->hasTable('topic_policysets')) {
            $this->execute("
        ...
        if (!$this->hasTable('topic_policies')) {
            $this->execute("
        ...
        if (!$this->hasTable('topic_epobjects')) {
            $this->execute("

...
class Constituencies
{
    ...
    /**
     * Normalise Constituency Names
     *
     * Normalise a set of constituency names all at once.
     *
     * @param $names array A list of constituency names to normalise.
     *
     * @return array The list of normalised constituency names.
     */

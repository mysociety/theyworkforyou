...
class MultiServiceSubscribeForm(forms.Form):
    ...
    democlub_signup = forms.BooleanField(label='Join transparency network DemocracyClub')
    twfy_signup = forms.BooleanField(label='Email me when my new MP speaks in Parliament')
    hfymp_signup = forms.BooleanField(label='Hear from my new MP and discuss issues')

# Django settings for electionsurvey project.
...
SECRET_KEY = 'owrhn&l07ts$!ix@8qviwjg4q)9)zkfoo-7m&78t+_!2r=x+to'
...
MIDDLEWARE_CLASSES = (
    'google.appengine.ext.appstats.recording.AppStatsDjangoMiddleware', # always put it first
